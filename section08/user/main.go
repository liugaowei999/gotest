...
import (
	...
	"github.com/lgw/micro-go-course/section08/user/endpoint"
	"github.com/lgw/micro-go-course/section08/user/redis"
	"github.com/lgw/micro-go-course/section08/user/service"
	"github.com/lgw/micro-go-course/section08/user/transport"
	"log"
	"net/http"
	"os"
	"os/signal"
